...
HD_PWD='C:/Users/Kashif/Desktop/WS2024/EMP 2/LAB/PROJECT/Microblaze.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_microblaze_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_microblaze_wrapper.tcl
