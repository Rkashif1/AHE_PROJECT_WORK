...
HD_PWD='C:/Users/Kashif/Desktop/WS2024/EMP 2/LAB/PROJECT/Microblaze.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_microblaze_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_microblaze_wrapper.tcl -notrace
