...
HD_PWD='C:/Users/Kashif/Desktop/WS2024/EMP 2/LAB/PROJECT/Microblaze.runs/design_microblaze_dlmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_microblaze_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_microblaze_dlmb_bram_if_cntlr_0.tcl
