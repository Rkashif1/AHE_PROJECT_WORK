...
HD_PWD='C:/FullAdder/Task2_BCD_Segments/Task2_BCD_Segments.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Task2_Design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Task2_Design_wrapper.tcl
