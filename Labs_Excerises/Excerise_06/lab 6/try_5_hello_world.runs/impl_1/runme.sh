...
HD_PWD='C:/Users/kapug/try_5_hello_world/try_5_hello_world.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log try_5_at_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source try_5_at_wrapper.tcl -notrace
