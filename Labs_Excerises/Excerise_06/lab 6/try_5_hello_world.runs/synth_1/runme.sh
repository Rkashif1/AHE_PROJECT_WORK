...
HD_PWD='C:/Users/kapug/try_5_hello_world/try_5_hello_world.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log try_5_at_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source try_5_at_wrapper.tcl
