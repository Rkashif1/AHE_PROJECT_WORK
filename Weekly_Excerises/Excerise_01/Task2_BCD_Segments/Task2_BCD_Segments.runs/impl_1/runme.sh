...
HD_PWD='C:/FullAdder/Task2_BCD_Segments/Task2_BCD_Segments.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Task2_Design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Task2_Design_wrapper.tcl -notrace
