...
HD_PWD='C:/FullAdder/Task1_ADDER/Task1_ADDER.runs/FourBitAdder_OneBitAdder_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FourBitAdder_OneBitAdder_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FourBitAdder_OneBitAdder_0_0.tcl
