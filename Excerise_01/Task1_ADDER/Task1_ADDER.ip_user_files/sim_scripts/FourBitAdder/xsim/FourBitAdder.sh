...
#
# Script generated by Vivado on Wed Nov 13 22:39:05 +0100 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : FourBitAdder.sh
...
#
# Usage        : FourBitAdder.sh
#                FourBitAdder.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                FourBitAdder.sh [-reset_run]
#                FourBitAdder.sh [-reset_log]
#                FourBitAdder.sh [-help]
#
...
# script info
echo -e "FourBitAdder.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./FourBitAdder.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xlslice_v1_0_2 -L xlconcat_v2_1_4 -L xlconstant_v1_1_7 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot FourBitAdder xil_defaultlib.FourBitAdder xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim FourBitAdder -key {Behavioral:sim_1:Functional:FourBitAdder} -tclbatch cmd.tcl -protoinst "protoinst_files/FourBitAdder.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb FourBitAdder.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./FourBitAdder.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: FourBitAdder.sh [-help]\n\
Usage: FourBitAdder.sh [-step]\n\
Usage: FourBitAdder.sh [-lib_map_path]\n\
Usage: FourBitAdder.sh [-reset_run]\n\
Usage: FourBitAdder.sh [-reset_log]\n\
Usage: FourBitAdder.sh [-keep_index]\n\
Usage: FourBitAdder.sh [-noclean_files]\n\n\
