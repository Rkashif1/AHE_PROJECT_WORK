...
HD_PWD='C:/FullAdder/Task2_BCD_Segments/Task2_BCD_Segments.runs/Task2_Design_clk_wiz_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Task2_Design_clk_wiz_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Task2_Design_clk_wiz_0.tcl
